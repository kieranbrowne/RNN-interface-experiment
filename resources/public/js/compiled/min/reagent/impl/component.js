...
if((i < len)){
var k = (ks[i]);
var G__17464 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__17465 = (i + (1));
m = G__17464;
i = G__17465;
continue;
...
return (cljs.core.fn_QMARK_(c)) && (cljs.core.some_QMARK_((function (){var G__17469 = c;
var G__17469__$1 = (((G__17469 == null))?null:G__17469.prototype);
if((G__17469__$1 == null)){
return null;
} else {
return (G__17469__$1["reagentRender"]);
}
})()));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return (cljs.core.fn_QMARK_(c)) && (cljs.core.some_QMARK_((function (){var G__17473 = c;
var G__17473__$1 = (((G__17473 == null))?null:G__17473.prototype);
if((G__17473__$1 == null)){
return null;
} else {
return (G__17473__$1["render"]);
}
})()));
});
...
return (function() { 
var G__17479__delegate = function (args){
var G__17477 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__17477) : reagent.impl.component.as_element.call(null,G__17477));
};
...
while (G__17480__i < G__17480__a.length) {G__17480__a[G__17480__i] = arguments[G__17480__i + 0]; ++G__17480__i;}
  args = new cljs.core.IndexedSeq(G__17480__a,0);
} 
return G__17479__delegate.call(this,args);};
G__17479.cljs$lang$maxFixedArity = 0;
G__17479.cljs$lang$applyTo = (function (arglist__17481){
var args = cljs.core.seq(arglist__17481);
return G__17479__delegate(args);
});
...
var _STAR_current_component_STAR_17484 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_17484;
}});
...
var G__17492 = (((key instanceof cljs.core.Keyword))?key.fqn:null);
switch (G__17492) {
...
return ((function (G__17492){
return (function reagent$impl$component$custom_wrapper_$_getInitialState(){
var c = this;
var G__17495 = reagent.impl.component.state_atom(c);
var G__17496 = f.call(c,c);
return (cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2 ? cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2(G__17495,G__17496) : cljs.core.reset_BANG_.call(null,G__17495,G__17496));
});
;})(G__17492))
...
var c = this;
var G__17498_17500 = (c["cljsRatom"]);
if((G__17498_17500 == null)){
} else {
reagent.ratom.dispose_BANG_(G__17498_17500);
}
...
var renders_17503 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_17504 = cljs.core.first(cljs.core.vals(renders_17503));
if((cljs.core.count(renders_17503) > (0))){
} else {
...
if(((1) === cljs.core.count(renders_17503))){
} else {
...
if(cljs.core.ifn_QMARK_(render_fun_17504)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("Render must be a function, not "),cljs.core.str(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([render_fun_17504], 0)))].join('')),cljs.core.str("\n"),cljs.core.str("(ifn? render-fun)")].join('')));
}


var render_fun = (function (){var or__6417__auto__ = cljs.core.cst$kw$reagentRender.cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__6417__auto__)){
return or__6417__auto__;
} else {
...
var name = [cljs.core.str((function (){var or__6417__auto__ = cljs.core.cst$kw$displayName.cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__6417__auto__)){
return or__6417__auto__;
} else {
...
var name__$1 = (function (){var G__17502 = name;
switch (G__17502) {
case "":
...
var elem = (function (){var G__17513 = (function (){var or__6417__auto__ = (function (){var G__17515 = c;
if((G__17515 == null)){
return null;
} else {
return (G__17515["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__6417__auto__)){
return or__6417__auto__;
...
return (G__17513["_currentElement"]);
}
})();
var name = (function (){var G__17516 = elem;
var G__17516__$1 = (((G__17516 == null))?null:(G__17516["type"]));
if((G__17516__$1 == null)){
return null;
} else {
return (G__17516__$1["displayName"]);
}
})();
var path = (function (){var G__17517 = elem;
var G__17517__$1 = (((G__17517 == null))?null:(G__17517["_owner"]));
var G__17517__$2 = (((G__17517__$1 == null))?null:reagent$impl$component$component_path(G__17517__$1));
if((G__17517__$2 == null)){
return null;
} else {
return [cljs.core.str(G__17517__$2),cljs.core.str(" > ")].join('');
}
})();
...
var n = (function (){var or__6417__auto__ = reagent.impl.component.component_path(c);
if(cljs.core.truth_(or__6417__auto__)){
return or__6417__auto__;
} else {
var G__17519 = c;
var G__17519__$1 = (((G__17519 == null))?null:G__17519.constructor);
if((G__17519__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__17519__$1);
}
}
})();
