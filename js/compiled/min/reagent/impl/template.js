...
return cljs.core._write(writer__7024__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__17549 = o;
(G__17549[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__17551__i < G__17551__a.length) {G__17551__a[G__17551__i] = arguments[G__17551__i + 0]; ++G__17551__i;}
  args = new cljs.core.IndexedSeq(G__17551__a,0);
} 
...
if(cljs.core.truth_((function (){var and__6405__auto__ = cljs.core.some_QMARK_(jsprops);
...
(G__17558["defaultValue"] = value);

(G__17558["onChange"] = ((function (G__17558,v,value,on_change){
return (function (p1__17555_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__17555_SHARP_);
});})(G__17558,v,value,on_change))
);

(G__17558["ref"] = ((function (G__17558,v,value,on_change){
return (function (p1__17556_SHARP_){
return (this$["cljsInputElement"] = p1__17556_SHARP_);
});})(G__17558,v,value,on_change))
);
...
var vec__17565 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17565,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17565,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17565,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___17570 = reagent.impl.template.key_from_vec(v);
if((temp__4661__auto___17570 == null)){
} else {
var key_17571 = temp__4661__auto___17570;
(jsprops["key"] = key_17571);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__17573 = (new reagent.impl.template.NativeWrapper());
(G__17573["name"] = c);
...
var G__17575 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__17575) : reagent.impl.template.as_element.call(null,G__17575));
} else {
...
var len__7492__auto___17581 = arguments.length;
var i__7493__auto___17582 = (0);
while(true){
if((i__7493__auto___17582 < len__7492__auto___17581)){
args__7499__auto__.push((arguments[i__7493__auto___17582]));

var G__17583 = (i__7493__auto___17582 + (1));
i__7493__auto___17582 = G__17583;
continue;
} else {
}
break;
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq17579){
var G__17580 = cljs.core.first(seq17579);
var seq17579__$1 = cljs.core.next(seq17579);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__17580,seq17579__$1);
});
...
break;
default:
var G__17587 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__17587;
continue;
...
var n__7332__auto___17590 = a.length;
var i_17591 = (0);
while(true){
if((i_17591 < n__7332__auto___17590)){
(a[i_17591] = reagent.impl.template.as_element((a[i_17591])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__7332__auto___17593 = a.length;
var i_17594 = (0);
while(true){
if((i_17594 < n__7332__auto___17593)){
var val_17595 = (a[i_17594]);
if((cljs.core.vector_QMARK_(val_17595)) && ((reagent.impl.template.key_from_vec(val_17595) == null))){
(o["no-key"] = true);
} else {
}

(a[i_17594] = reagent.impl.template.as_element(val_17595));
...
var ctx = ({});
var vec__17600 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17600,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17600,(1),null);
...
var G__17604 = (cljs.core.count(argv) - first_child);
switch (G__17604) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__17604){
